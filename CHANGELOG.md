...
- Web search/SearXNG: add SearXNG as a web search provider option (`tools.web.search.provider="searxng"`) with configurable `baseUrl`, enabling self-hosted privacy-focused web search integration.
