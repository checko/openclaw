...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider ("brave", "perplexity", "grok", "gemini", "kimi", or "searxng"). Auto-detected from available API keys or baseUrl if omitted.',
  ...
  "tools.web.search.searxng.baseUrl":
    "SearXNG instance base URL (e.g. http://localhost:8080/Search).",
